...
export const organizations = [
  { id: 'org_1', name: 'TechCorp International', industry: 'Technology', employees: 245, location: 'Casablanca, Morocco', email: 'contact@techcorp.ma', phone: '+212 522 123 456', status: 'active', plan: 'Enterprise', created: 'Jan 15, 2025' },
  { id: 'org_2', name: 'FinServe Global', industry: 'Finance', employees: 189, location: 'Rabat, Morocco', email: 'info@finserve.ma', phone: '+212 537 654 321', status: 'active', plan: 'Business', created: 'Mar 8, 2025' },
  { id: 'org_3', name: 'MediCare Plus', industry: 'Healthcare', employees: 156, location: 'Marrakech, Morocco', email: 'hello@medicare.ma', phone: '+212 524 789 012', status: 'active', plan: 'Enterprise', created: 'Jun 22, 2025' },
];
...
export const users = [
  { 
    ...
    orgId: 'org_1',
    cnss: '123456789',
    rib: 'MA64 001 000 12345678901234 56',
  ...
  { 
    ...
    orgId: 'org_1',
    cnss: '987654321',
    rib: 'MA64 001 000 98765432109876 54',
  ...
  { 
    ...
    orgId: 'org_1',
    cnss: '456789123',
    rib: 'MA64 001 000 45678912304567 89',
    phone: '+212 600 000 004'
  },
  { 
    id: 11, 
    name: 'John Doe', 
    email: 'john.doe@finserve.ma', 
    role: 'Employee', 
    department: 'Finance', 
    status: 'active', 
    lastLogin: '1d ago', 
    ...
    orgId: 'org_2',
    cnss: '321654987',
    rib: 'MA64 001 000 32165498703216 54',
...
// ... other dashboard data remains the same for now
export const hrData = {
  stats: [
