...
function TeamMemberCard({ member }) {
  ...
  return (
    <div className="flex items-center gap-3 p-3.5 rounded-xl bg-surface-secondary border border-border-secondary
                    hover:border-amber-300 transition-all duration-200 group">
      {/* Avatar */}
      <div className="flex items-center justify-center w-10 h-10 rounded-full
                      bg-gradient-to-br from-amber-500/20 to-orange-500/20
                      text-sm font-bold text-amber-600 shrink-0">
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                           ...
                           text-sm font-semibold shadow-md shadow-amber-500/20
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5">
        <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
          ...
          <MiniChart
            ...
            height={100}
            colorFrom="oklch(0.65 0.18 70)"
            colorTo="oklch(0.78 0.15 70)"
          />
        </div>
        ...
        <div className="bg-surface-primary rounded-2xl border border-border-secondary p-5
          ...
          <h2 className="text-sm font-semibold text-text-primary mb-4">Process Completion Trend</h2>
          <MiniChart
            data={managerData.processCompletion}
            label="Processes completed per week"
            height={100}
            colorFrom="oklch(0.60 0.16 40)"
            colorTo="oklch(0.75 0.14 40)"
          />
        </div>
      </div>
